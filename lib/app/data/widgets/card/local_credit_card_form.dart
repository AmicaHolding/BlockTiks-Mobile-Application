...
class LocalCreditCardForm extends StatefulWidget {
  const LocalCreditCardForm({
    Key? key,
  ...
  @override
  LocalCreditCardFormState createState() => LocalCreditCardFormState();
}

class LocalCreditCardFormState extends State<LocalCreditCardForm> {
